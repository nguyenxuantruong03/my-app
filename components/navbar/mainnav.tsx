  ...
  import { AlignJustify,ChevronDown,MapPin,Phone,UserCircle2,Truck,ShoppingBag } from "lucide-react";
  ...
  const MainNav = () => {
    ...
    if(!isMounted){
      ...
      return ( 
          ...
          <Link href="/">
            <div className="bg-[#e53350] p-2 rounded-lg">
          ...
          <Link href="/">
            <div className="bg-[#e53350]  px-2  rounded-lg ">
              ...
              <div className="text-xs flex gap-3 text-white">
                  Xem giá tại
                  <p className="text-white">
                      <ChevronDown className= "w-3 h-4"/>
                  </p>
                  </div>
              <div className="text-md w-24 text-white">Ho Chi Minh</div>
              </div>
              </div>
              </div>
            </div>
