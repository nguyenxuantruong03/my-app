...
interface IphoneListPorps {
  data: Ipad[];
}

const ProductListSingnleiPad: React.FC<IphoneListPorps> = ({ data }) => {
          ...
          <SwiperSlide key={product.id}>
            ...
            >
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-gray-500">{product.categoryipad.name}</p>
              </div>
...
export default ProductListSingnleiPad;
