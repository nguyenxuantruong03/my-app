    ...
    <div className="max-w-2xl">
      <div className="hidden lg:grid  lg:grid-cols-2 lg:item-start lg:gap-x-8  mb-5">
        <div className="w-[300px] h-[200px] shadow-lg rounded-md p-4 ">
          <h1 className="font-bold text-md text-[#666666]">
            Thông tin sản phẩm
          </h1>
          ...
          <div className="flex my-1 text-[#666666]">
            ...
            <span className=" ml-1 text-sm">
              {" "}
              {data.name}, vệ sinh miễn phí trong vòng 1 năm{" "}
            </span>
          </div>
          <div className="flex my-1 text-[#666666]">
            ...
            <span className="ml-1 text-sm">
              {" "}
              Bảo hành 24 tháng trung tâm bảo hành Chính hãng, 1 đổi 1 trong 30
              ngày nếu có lỗi từ phía nhà sản xuất{" "}
            </span>
          </div>
          <div className="flex my-1 text-[#666666]">
          ...
          <div className="h-[90px] shadow-md my-[10px] rounded-md overflow-hidden">
            ...
            <div className="flex text-[#666666] my-2">
              ...
              <p className="ml-1 text-sm">
                {" "}
                Giảm thêm 500k khi có thẻ sinh viên{" "}
              </p>
            </div>
          </div>
        </div>
      ...
      <div
        ...
        className="w-[550px] h-[50px] shadow-lg rounded-md mt-2 ml-[40px] flex items-center justify-center hover:bg-red-300 hover:bg-opacity-30 hover:border-[1px] hover:border-red-500 hover:text-red-600 cursor-pointer"
      >
