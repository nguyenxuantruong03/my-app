...
const SwiperButtons = () => {
  ...
  return (
    ...
    <div className=" relative ">
        <div className=" left-[718px] cursor-pointer absolute rounded-l-full rounded-r-none  bg-white bg-opacity-70 text-gray-500 top-[112px] animate-fade-left animate-once animate-duration-500 animate-ease-in-out animate-normal animate-fill-forwards">
