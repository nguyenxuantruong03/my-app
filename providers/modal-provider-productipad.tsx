...
import SeeDetailSpecifications from "@/components/modal/see-detail-model-specificationipad";
...
const ModalProviderProductIpad:React.FC<ModalProviderProps> = ({data}) => {
...
export default ModalProviderProductIpad;