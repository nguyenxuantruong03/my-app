...
import SeeDetailSpecifications from "@/components/modal/see-detail-model-specificationmouse";
...
const ModalProviderProductMouse:React.FC<ModalProviderProps> = ({data}) => {
...
export default ModalProviderProductMouse;