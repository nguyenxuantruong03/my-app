...
import InfoProduct from "@/components/info-product/info-product5/info-product";
import InfoWarranty from "@/components/info-product/info-product5/infowarranty";
import InfoPromotion from "@/components/info-product/info-product5/info-promotion";
...
import DetailProduct from "@/components/info-product/info-product5/detail-product";
import ModalProviderProduct5 from "@/providers/modal-provider-product5";
...
const ProductPage: React.FC<PropductPageProps> = async ({ params }) => {
  ...
  return (
    <div className="bg-white">
      ...
      <ModalProviderProduct5 data={product} />
    </div>
  );
};
