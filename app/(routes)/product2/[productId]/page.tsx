...
import InfoProduct from "@/components/info-product/info-product2/info-product";
import InfoWarranty from "@/components/info-product/info-product2/infowarranty";
import InfoPromotion from "@/components/info-product/info-product2/info-promotion";
import ProductListSingnle2 from "@/components/product/product-list/product-list-single2";
import getBillboardmini from "@/actions/billboard/get-billboardmini";
import Image from "next/image";
import DetailProduct from "@/components/info-product/info-product2/detail-product";
import ModalProviderProduct2 from "@/providers/modal-provider-product2";
import getProducts2 from "@/actions/products/get-headphone2";
  ...
  return (
    <div className="bg-white">
      <Container>
        ...
        <ProductListSingnle2 data={suggestedProducts} />
        <hr className="my-5" />
