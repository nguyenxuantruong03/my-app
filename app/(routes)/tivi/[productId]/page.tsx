...
import InfoProduct from "@/components/info-product/info-producttivi/info-product";
import InfoWarranty from "@/components/info-product/info-producttivi/infowarranty";
import InfoPromotion from "@/components/info-product/info-producttivi/info-promotion";
import getBillboardmini from "@/actions/billboard/get-billboardmini";
import Image from "next/image";
import DetailProduct from "@/components/info-product/info-producttivi/detail-product";
import ModalProviderProductTivi from "@/providers/modal-provider-producttivi";
...
const ProductPage: React.FC<PropductPageProps> = async ({ params }) => {
  ...
  const product = await getTivi(params.productId);

  const suggestedProducts = await getProductTivi({
    categorytiviId: product?.categorytivi?.id,
  });
  ...
  return (
    <div className="bg-white">
      ...
      <ModalProviderProductTivi data={product} />
    </div>
  );
};
