...
import { Billboard, Color, Product7, Size } from "@/types";
...
const CategoryPage: React.FC<CategoryPageProps> = ({
  ...
  const [product, setProduct] = useState<Product7[]>([]);
  ...
  const filterProductsByPrice = (products: Product7[]) => {
    ...
    const fetchData = async () => {
      try {
        const billboardData = await getBillboard(
          "13c6b333-d51d-454d-85b0-5d975465017e"
        );
        const productData = await getProduct7({
