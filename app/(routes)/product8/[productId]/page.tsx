...
import InfoProduct from "@/components/info-product/info-product8/info-product";
import InfoWarranty from "@/components/info-product/info-product8/infowarranty";
import InfoPromotion from "@/components/info-product/info-product8/info-promotion";
import ProductListSingnle8 from "@/components/product/product-list/product-list-single8";
import getBillboardmini from "@/actions/billboard/get-billboardmini";
import Image from "next/image";
import DetailProduct from "@/components/info-product/info-product8/detail-product";
import ModalProviderProduct8 from "@/providers/modal-provider-product8";
import getProducts8 from "@/actions/products/get-bumper8";
  ...
  return (
    <div className="bg-white">
      <Container>
        ...
        <ProductListSingnle8 data={suggestedProducts} />
        <hr className="my-5" />
        <DetailProduct data={product} />
      </Container>
      <ModalProviderProduct8 data={product} />
    </div>
  );
};
