...
import InfoProduct from "@/components/info-product/info-product9/info-product";
import InfoWarranty from "@/components/info-product/info-product9/infowarranty";
import InfoPromotion from "@/components/info-product/info-product9/info-promotion";
import ProductListSingnle9 from "@/components/product/product-list/product-list-single9";
import getBillboardmini from "@/actions/billboard/get-billboardmini";
import Image from "next/image";
import DetailProduct from "@/components/info-product/info-product9/detail-product";
import ModalProviderProduct9 from "@/providers/modal-provider-product9";
import getProducts9 from "@/actions/products/get-mouse9";
  ...
  return (
    <div className="bg-white">
      <Container>
        ...
        <ProductListSingnle9 data={suggestedProducts} />
        <hr className="my-5" />
        <DetailProduct data={product} />
      </Container>
      <ModalProviderProduct9 data={product} />
    </div>
  );
};
